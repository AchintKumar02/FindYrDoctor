Public Class Appt_Records_Form
    ...
    Private Sub Appt_DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles Appt_DataGridView1.CellClick
        ...
        Appt_Form.Pt_Ph_No_txtbox.Text = Appt_DataGridView1.CurrentRow.Cells(5).Value
        Appt_Form.Pt_Age_txtbox.Text = Appt_DataGridView1.CurrentRow.Cells(6).Value
        ...
        Appt_Form.Dr_Category.Text = Appt_DataGridView1.CurrentRow.Cells(9).Value
    End Sub
